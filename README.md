...
- `frontend/public/robots.txt` — replace `YOUR_DOMAIN.com` with your real domain
- `frontend/public/sitemap.xml` — replace `YOUR_DOMAIN.com` with your real domain
- `frontend/index.html` — replace all `YOUR_DOMAIN.com` occurrences with your real domain
- Redeploy to Vercel.
